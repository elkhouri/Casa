module UsersHelper
  ...
  def gravatar_thumbnail(user, options = { size: 100 })
    ...
    size = options[:size]
    gravatar_url = "https://secure.gravatar.com/avatar/#{gravatar_id}?s=#{size}&d=mm"
    content = 'Grade: <br>Feedback:<br>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur id ipsum ut orci cursus dictum. Ut dictum scelerisque interdum'
